...
TextStyle lightTitleTextSmall = GoogleFonts.roboto(
...
TextStyle lightBodyTextMedium = GoogleFonts.roboto(
    fontWeight: FontWeight.bold, fontSize: 20, color: Colors.black);

TextStyle darkTitleTextLarge = GoogleFonts.poppins(
    fontWeight: FontWeight.bold, fontSize: 22, color: Colors.black);

TextStyle darkTitleTextSmall = GoogleFonts.roboto(
